...
argument-hint: project-name (default chatkeep-admin)
---
...
```
$ARGUMENTS/ (default: chatkeep-admin/)
├── core/
...
```
/init-mobile                    # Creates chatkeep-admin/
...
Project name: **$ARGUMENTS** (defaults to "chatkeep-admin" if empty)
