...
### Default Values
- **Project Name**: chatkeep-admin
- **Package**: com.chatkeep.admin
- **Directory**: ./chatkeep-admin/
- **Min Android SDK**: 24
- **iOS Target**: iOS 15.0+
- **Java Version**: 17
...
│   ├── common/
│   │   ├── build.gradle.kts
│   │   └── src/commonMain/kotlin/com/chatkeep/admin/core/common/
│   │       ├── AppResult.kt
│   │       └── Extensions.kt
│   │
│   ├── data/
│   │   ├── build.gradle.kts
│   │   └── src/
│   │       ├── commonMain/kotlin/com/chatkeep/admin/core/data/
...
│   ├── database/
│   │   ├── build.gradle.kts
│   │   └── src/commonMain/kotlin/com/chatkeep/admin/core/database/
│   │       ├── AppDatabase.kt
│   │       └── entities/
│   │
│   ├── network/
│   │   ├── build.gradle.kts
│   │   └── src/commonMain/kotlin/com/chatkeep/admin/core/network/
│   │       ├── ApiService.kt
│   │       └── di/NetworkModule.kt
│   │
│   └── ui/
│       ├── build.gradle.kts
│       └── src/commonMain/
│           ├── kotlin/com/chatkeep/admin/core/ui/
│           │   ├── theme/
│           │   │   ├── Theme.kt
│           │   │   ├── Type.kt
│           │   │   └── Shapes.kt
...
│       ├── api/
│       │   ├── build.gradle.kts
│       │   └── src/commonMain/kotlin/com/chatkeep/admin/feature/home/
│       │       ├── HomeComponent.kt
│       │       └── HomeModels.kt
│       └── impl/
│           ├── build.gradle.kts
...
│   ├── build.gradle.kts
│   └── src/
│       ├── commonMain/kotlin/com/chatkeep/admin/
│       │   ├── App.kt
│       │   ├── RootComponent.kt
│       │   └── di/
│       ├── androidMain/
│       │   ├── AndroidManifest.xml
│       │   └── kotlin/com/chatkeep/admin/
│       │       ├── MainActivity.kt
│       │       └── di/AndroidAppGraph.kt
│       ├── iosMain/kotlin/com/chatkeep/admin/
│       │   ├── MainViewController.kt
│       │   └── di/IosAppGraph.kt
│       ├── jvmMain/kotlin/com/chatkeep/admin/
│       │   ├── Main.kt
│       │   └── di/DesktopAppGraph.kt
│       └── wasmJsMain/kotlin/com/chatkeep/admin/
│           ├── Main.kt
│           └── di/WasmAppGraph.kt
│
└── iosApp/
...
```
## Project Created: chatkeep-admin
