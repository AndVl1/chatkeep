...
```bash
# Docker
docker build -t chatkeep:test .
docker run --rm chatkeep:test java -version

# Helm
helm lint ./helm/chatkeep
helm template ./helm/chatkeep --debug
...
## Files Modified
- helm/chatkeep/values.yaml (added env var)
- helm/chatkeep/templates/configmap.yaml (added entry)
...
- Rollback: helm rollback chatkeep [revision]
