...
/**
 * Dependency graph for iOS platform.
 * Manual DI - ready for Metro migration when available.
 */
class IosAppGraph {

    // Platform-specific
    private val dataStore: DataStore<Preferences> = IosModule.provideDataStore()
    val tokenStorage: TokenStorage = IosModule.provideTokenStorage(dataStore)
    val settingsRepository: SettingsRepository = IosModule.provideSettingsRepository(dataStore)
